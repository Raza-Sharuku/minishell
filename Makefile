...
SRCS = builtin_execute_error.c builtin.c cd_and_pwd.c dup2_close.c echo.c env.c execute_error.c execve.c execute_one_cmd.c \
	...
	parse_line_1.c parse_line_2.c split_str.c utils.c check_execute_error.c $(GNL)
